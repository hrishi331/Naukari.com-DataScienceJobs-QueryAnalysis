...
url = f"https://www.naukri.com/jobapi/v3/search?noOfResults=20&urlType=search_by_keyword&searchType=adv&keyword=data%20scientist&pageNo=1&sort=r&k=data%20scientist&nignbevent_src=jobsearchDeskGNB&seoKey=data-scientist-jobs-2&src=seo_srp&latLong=&sid=17501426147053681"
...
# for n,i in enumerate(info_dict.get('jobDetails')):
#     print(n)
#     print(i)
#     print('-'*100)
jdurl = info_dict.get('jobDetails')[0]['jdURL']
jdurl = ''.join(['https://www.naukri.com',jdurl])
review_count = info_dict.get('jobDetails')[0]['ambitionBoxData']['ReviewsCount']
rating = info_dict.get('jobDetails')[0]['ambitionBoxData']['AggregateRating']
